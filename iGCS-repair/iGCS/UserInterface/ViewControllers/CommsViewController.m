...
- (void) setDataRateRecorder:(DataRateRecorder *)dataRateRecorder {
    ...
    plotSpace.xRange = [CPTPlotRange plotRangeWithLocation:CPTDecimalFromFloat(0.0) length:CPTDecimalFromFloat([_dataRateRecorder maxDurationInSeconds])];
    ...
    CPTScatterPlot *dateRatePlot = [[CPTScatterPlot alloc] initWithFrame:self.dataRateGraph.bounds];
