...
- (void)awakeFromNib {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(craftCustomModeDidChange) name:GCSCraftNotificationsCraftCustomModeDidChange object:nil];

    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(craftArmedStatusDidChange) name:GCSCraftNotificationsCraftArmedStatusDidChange object:nil];
}
